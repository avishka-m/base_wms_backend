...
from .advanced_anomaly_detection import router as advanced_anomaly_detection_router
...
from .chatbot import (
    router as chatbot_router,  # Enhanced chatbot with persistent storage
)
...
api_router.include_router(
    prophet_router, prefix="/prophet", tags=["Prophet Forecasting"]
)

api_router.include_router(
    role_based_router, prefix="/role-based", tags=["Role-Based Operations"]
)
api_router.include_router(
    workflow_router, prefix="/workflow", tags=["Workflow Management"]
)

api_router.include_router(
    storage_history_router, prefix="/storage-history", tags=["Storage History"]
)
api_router.include_router(seed_data_router, prefix="/seed-data", tags=["Seed Data"])
api_router.include_router(
    inventory_increases_router,
    prefix="/inventory-increases",
    tags=["Inventory Increases"],
)
api_router.include_router(
    location_inventory_router, prefix="/location-inventory", tags=["Location Inventory"]
)
api_router.include_router(ai_router, prefix="/ai", tags=["AI/ML Predictions"])

api_router.include_router(
    worker_location_router, prefix="/worker-location", tags=["Worker Location"]
)


api_router.include_router(
    chatbot_router, prefix="/chatbot", tags=["AI Chatbot"]
)  # Enhanced chatbot with persistent storage
api_router.include_router(
    advanced_anomaly_detection_router,
...
api_router.include_router(
    websocket_admin_router, prefix="/admin", tags=["WebSocket Admin"]
