...
class KnowledgeBase:
    ...
    def __init__(self):
        ...
        # Only initialize OpenAI embeddings if API key is provided
        if OPENAI_API_KEY:
            ...
            print("Warning: OPENAI_API_KEY not set. Knowledge base will use mock components.")
    ...
    def query(self, query: str, n_results: int = 5, 
        ...
        if self.db is None:
            return []  # Return empty results if no database available
