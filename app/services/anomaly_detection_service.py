...
class AnomalyDetectionService:
    ...
    async def detect_all_anomalies(self) -> Dict[str, List[Dict[str, Any]]]:
        ...
        try:
            ...
            logger.info(
                f"✅ Anomaly detection complete! Found {total_anomalies} anomalies"
            )
            return anomalies
        ...
        try:
            ...
            for item in items:
                ...
                if (
                    ...
                    > self.thresholds["inventory"]["impossible_quantity"]
                ):
                    item_anomalies.append(
                        {
                    ...
                    item_anomalies.append(
                        {
                            ...
                            "description": "Below minimum threshold by significant margin",
    ...
    async def detect_order_anomalies(self) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            for order in recent_orders:
                ...
                total_quantity = sum(
                    item.get("quantity", 0) for item in order.get("order_details", [])
                )
                ...
                if (
                    order_hour >= self.thresholds["orders"]["midnight_start"]
                    or order_hour <= self.thresholds["orders"]["midnight_end"]
                ):
                    order_anomalies.append(
                        {
                            "type": "midnight_order",
        ...
        try:
            ...
            for area in workflow_areas:
                ...
                for item in recent_items:
                    ...
                    if (
                        processing_time
                        > self.thresholds["workflow"]["processing_delay"]
                    ):
                        item_anomalies.append(
                            {
    ...
    async def _check_low_stock_anomaly(self, item: Dict) -> bool:
        ...
        try:
            ...
            return current_stock < (
                min_stock * self.thresholds["inventory"]["low_stock_multiplier"]
            )
        except:
            return False
